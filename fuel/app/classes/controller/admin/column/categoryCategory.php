...
class Controller_Admin_ColumnCategory extends Controller_Admin
{
	...
	public function action_index()
	{
		...
		$this->template->title = "Column_categories";
	...
	public function action_view($id = null)
	{
		...
		$this->template->title = "Column_category";
	...
	public function action_create()
	{
		if (Input::method() == 'POST')
		{
			...
			if ($val->run())
			{
				...
				{
					Session::set_flash('success', e('Added column_category #'.$column_category->id.'.'));
				...
				{
					Session::set_flash('error', e('Could not save column_category.'));
				}
			}
			else
			{
	...
	public function action_edit($id = null)
	{
		...
		if ($val->run())
		{
			...
			{
				Session::set_flash('success', e('Updated column_category #' . $id));
			...
			{
				Session::set_flash('error', e('Could not update column_category #' . $id));
			}
		}
	...
	public function action_delete($id = null)
	{
		if ($column_category = Model_Column_Category::find($id))
		{
			...
			Session::set_flash('success', e('Deleted column_category #'.$id));
		}

		else
		{
			Session::set_flash('error', e('Could not delete column_category #'.$id));
		}
